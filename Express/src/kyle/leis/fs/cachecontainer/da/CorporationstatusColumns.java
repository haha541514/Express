...
public class CorporationstatusColumns extends GeneralColumns implements Serializable {
	...
	public CorporationstatusColumns() {
		m_astrColumns = new String[3];
	}
	
	public CorporationstatusColumns(String csCscode, 
