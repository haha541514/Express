...
public class DicdistrictQuery extends HGeneralQuery {
	
	public DicdistrictQuery(){
	    m_strSelectClause = "SELECT new kyle.leis.fs.dictionary.district.da.DicdistrictColumns(di.dtCode, di.dtHubcode, di.dtName, di.dtEname, di.dtStatecode, di.dtStatename,     di.dtGrade, di.dtStartpostcode, di.dtEndpostcode, di.dtOpCodeCreator,     di.dtCreatedate, di.dtOpCodeModifier, di.dtModifydate, di.dtRemark, di.dtStartcitysign,     di.dtElevatedrisksign, di.dtRestrictedsign,      dd.dtCode,dd.dtName,dd.dtHubcode,dd.dtEname,dd.dtOpCodeCreator,dd.dtOpCodeModifier,     dk.dkCode, dk.dkName, dk.dkEname) FROM TdiDistrict as di inner join di.tdiDistrictkind as dk inner join di.tdiDistrict as dd";
	    m_strWhereClause = "";
	    m_strOrderByClause = "";
	    m_strGroupByClause = "";
	    m_astrConditionWords = new String[] { "di.dtCode = '~~'", "di.dtHubcode = '~~'", "di.dtName = '~~'", "di.dtEname = '~~'", "di.dtStatecode = '~~'", "di.dtStatename = '~~'", "di.dtGrade = '~~'", "di.dtStartpostcode = '~~'", "di.dtEndpostcode = '~~'", "di.dtOpCodeCreator = '~~'", "di.dtCreatedate >= to_date('~~','yyyy-mm-dd hh24:mi:ss')", "to_date('~~','yyyy-mm-dd hh24:mi:ss') >= di.dtCreatedate", "di.dtOpCodeModifier = '~~'", "di.dtModifydate >= to_date('~~','yyyy-mm-dd hh24:mi:ss')", "to_date('~~','yyyy-mm-dd hh24:mi:ss') >= cr.dtModifydate", "di.dtRemark = '~~'", "di.dtStartcitysign = '~~'", "di.dtElevatedrisksign = '~~'", "di.dtRestrictedsign = '~~'", "dd.dtCode = '~~'", "dk.dkCode = '~~'", "dk.dkName = '~~'", "dk.dkEname = '~~'" };
