...
public class AlldhldistrictQuery extends JGeneralQuery {
	
	public AlldhldistrictQuery(){
	    m_strSelectClause = "SELECT dhl.dd_cityname,dhl.dd_hubcode,dhl.dd_startpostcode,dhl.dd_endtpostcode,dhl.dd_locationcode,dhl.DD_STATECODE,dhl.DD_STATENAME FROM t_di_dhldistrict dhl";
	    m_strWhereClause = "";
	    m_strOrderByClause = "";
	    m_strGroupByClause = "";
	...
	public IColumns createColumns() {
		...
		return new AlldhldistrictColumns();
	}
