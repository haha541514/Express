...
public class SumhasaccountrvColumns extends GeneralColumns implements Serializable {
	...
	public SumhasaccountrvColumns() {
		m_astrColumns = new String[1];
	}
	
	public SumhasaccountrvColumns(String Sumrvtotal){
		m_astrColumns = new String[1];
