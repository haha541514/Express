...
public class ReceivableforbillColumns extends GeneralColumns implements Serializable {
	...
	public ReceivableforbillColumns() {
		m_astrColumns = new String[91];
	}
	
	public ReceivableforbillColumns(Long rvRvid, 
