...
public class SumcorreceivableColumns extends GeneralColumns implements Serializable {
	...
	public SumcorreceivableColumns() {
		m_astrColumns = new String[1];
	}
	
	public SumcorreceivableColumns(String Sumrvtotal){
		m_astrColumns = new String[1];
