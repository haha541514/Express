...
public class HousewaybillforcustomsQuery extends JGeneralQuery {
	...
	public void setEestructurecode(String eeStructurecode) {
		this.setField(41, eeStructurecode);
	}
