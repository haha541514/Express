...
public class HousewaybillforcustomsColumns extends GeneralColumns implements Serializable {
	...
	public HousewaybillforcustomsColumns() {
		m_astrColumns = new String[89];
	}
	
	public HousewaybillforcustomsColumns(String hwCw_code, 
            ...
            String Cobalanceamount, String Totalcargoinfo, 
            String Cargoinfo, String Cargohscode){
		m_astrColumns = new String[89];
	...
	public void setTotalcargoinfo(String Totalcargoinfo) {
		this.setField(86, Totalcargoinfo);
	}
	...
	public void setCargohscode(String Cargohscode) {
		this.setField(88, Cargohscode);
	}

	public String getCargohscode() {
