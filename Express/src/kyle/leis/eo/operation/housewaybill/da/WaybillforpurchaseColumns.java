...
public class WaybillforpurchaseColumns extends GeneralColumns implements Serializable {
	...
	public WaybillforpurchaseColumns() {
		m_astrColumns = new String[37];
	}
	
	public WaybillforpurchaseColumns(String cwCw_code, 
            ...
            String cwsCws_name, String Pytotal,
            String Pypurchasetotal, String scoCo_code, 
            String scoCo_labelcode, String scoCo_sname){
		m_astrColumns = new String[37];
		...
		setPytotal(Pytotal);
        setPypurchasetotal(Pypurchasetotal);
	...
	public void setPypurchasetotal(String Pypurchasetotal) {
		this.setField(33, Pypurchasetotal);
	}

	public String getPypurchasetotal() {
		return this.getField(33);
	}

	public void setScoco_code(String scoCo_code) {
		this.setField(34, scoCo_code);
	}
	...
	public void setScoco_labelcode(String scoCo_labelcode) {
		this.setField(35, scoCo_labelcode);
	}
