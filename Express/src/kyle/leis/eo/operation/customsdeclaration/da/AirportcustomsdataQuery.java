...
public class AirportcustomsdataQuery extends JGeneralQuery {
	
	public AirportcustomsdataQuery(){
	    m_strSelectClause = "SELECT cw.cw_serverewbcode,'B' as customstype, FUN_GET_CARGOINFO(cw.cw_code) as CargoInfo,'' as cargotype, FUN_GET_CARGOHSCODE(cw.cw_code) as cargono,cw.cw_pieces,FUN_GET_TOTALCARGOPCS(cw.cw_code) as TotalCargoPCS,'' as unit,cw.cw_chargeweight,FUN_GET_TOTALCARGOINFO(cw.cw_code) as TotalCargoInfo,'142' as currency,'142' as shippercountry, '110' as origincountry,hw.hw_consigneename,hw.hw_consigneeaddress1||hw.hw_consigneeaddress2||hw.hw_consigneeaddress3 as hw_consigneeaddress,hw.hw_consigneetelephone, hw.hw_shippername,hw.hw_shipperaddress1||hw.hw_shipperaddress2||hw.hw_shipperaddress3 as hw_shipperaddress,hw.hw_shippertelephone FROM t_op_corewaybill cw,t_op_housewaybill hw,t_di_district shdt,t_di_district ddt,t_di_district cddt,t_op_batchwaybill bw";
	...
	public IColumns createColumns() {
		...
		return new AirportcustomsdataColumns();
	}
