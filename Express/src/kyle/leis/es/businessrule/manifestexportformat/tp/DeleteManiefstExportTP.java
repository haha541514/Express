...
public class DeleteManiefstExportTP extends AbstractTransaction {
	...
	/**
	 * 20160905 setTbrManifestExportformat by wukaiquan 来个批量删除
	 * **/
	public void transaction(Session objSession) throws Exception {
		// 设置ss_code
		// 先删除子表
		// objSession.delete(" from TbrManifestefcolumn mefc where mefc.comp_id.mefCode = "
		// + m_mefcode);
		// 再删除主表
		// objSession.delete(" from TbrManifestexportformat mef where mef.mefCode = "
		// + m_mefcode);
		...
		String deleteSql = "update  t_br_Manifestexportformat mef set mef.ss_code = 'OFF' where mef.mef_Code = '"
				+ m_mefcode + "'";
