...
public class ManifeststandardcolumnColumns extends GeneralColumns implements Serializable {
	...
	public ManifeststandardcolumnColumns() {
		m_astrColumns = new String[4];
	}
	
	public ManifeststandardcolumnColumns(Long mscMsccode, 
