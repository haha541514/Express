...
public class FeegroupbyonylcwQuery extends JGeneralQuery {
	
	public FeegroupbyonylcwQuery(){
	    ...
	    m_strWhereClause = "cw.co_code_supplier = co.co_code and cw.ee_code = ee.ee_code and cw.co_code_customer = cm.co_code and cw.bw_code_arrival = bw.bw_code and cw.pk_code = pk.pk_code and co.co_code = cs.co_code and cw.chn_code_supplier = chn.chn_code and cw.cws_code NOT IN ('EL', 'CEL', 'CTS', 'CHP') ";
	    m_strOrderByClause = "";
	    m_strGroupByClause = "cw.co_code_supplier,co.co_sname,co.co_labelcode,ee.ee_sname";
	...
	public IColumns createColumns() {
		...
		return new FeegroupbyonylcwColumns();
	}
