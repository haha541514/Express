...
public class FeegroupbycoQuery extends JGeneralQuery {
	
	public FeegroupbycoQuery(){
	    ...
	    m_strOrderByClause = "";
	    m_strGroupByClause = "co.co_sname,pk.pk_sname,op.op_name,co.co_labelcode,ee.ee_sname";
	...
	public IColumns createColumns() {
		...
		return new FeegroupbycoColumns();
	}
